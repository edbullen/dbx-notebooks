...
# MAGIC %md
# MAGIC   
# MAGIC Optionally, skip forward to Train a Model - MLFlow.  This section covers a basic intro to training an ML model with Random Forest.  
...
# MAGIC 
# MAGIC 
# MAGIC <img src="https://drive.google.com/uc?export=view&id=1-Qchz3_BDdwFldRoQX1Tj2CwvX70XK4u" alt="drawing" width="800"/>
